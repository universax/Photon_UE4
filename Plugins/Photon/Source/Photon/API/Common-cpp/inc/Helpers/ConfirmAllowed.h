...
namespace Helpers
{
template <typename CType, unsigned int N = 0>
struct ConfirmAllowed
{
...
struct ConfirmAllowed<Dictionary<Key, Val>>
{
...
template <>
struct ConfirmAllowed<const char *>
{
	typedef JString type;
	typedef JString scalarType;
	static const unsigned int dimensions = 0;
...
template <unsigned int N>
struct ConfirmAllowed<const char[N]>
{
	typedef JString type;
	typedef JString scalarType;
	static const unsigned int dimensions = 0;
...
template <>
struct ConfirmAllowed<const wchar_t *>
{
	typedef JString type;
	typedef JString scalarType;
	static const unsigned int dimensions = 0;
...
template <unsigned int N>
struct ConfirmAllowed<wchar_t[N]>
{
	typedef JString type;
	typedef JString scalarType;
	static const unsigned int dimensions = 0;
...
template <unsigned int N>
struct ConfirmAllowed<const wchar_t[N]>
{
	typedef JString type;
	typedef JString scalarType;
	static const unsigned int dimensions = 0;
...
template <>
struct ConfirmAllowed<Hashtable>
{
...
struct ConfirmAllowed<const CType>
{
...
template <typename CType, unsigned int N>
struct ConfirmAllowed<CType[N]>
{
	typedef typename ConfirmAllowed<CType>::type *type;
	typedef typename ConfirmAllowed<CType>::scalarType scalarType;
	static const unsigned int dimensions = ConfirmAllowed<CType>::dimensions + 1;
...
template <typename CType, unsigned int N>
struct ConfirmAllowed<const CType[N]>
{
	typedef typename ConfirmAllowed<const CType>::type *type;
	typedef typename ConfirmAllowed<const CType>::scalarType scalarType;
	static const unsigned int dimensions = ConfirmAllowed<const CType>::dimensions + 1;
