...
template <>
struct ConfirmAllowedKey<nByte>
{
	typedef nByte type;
	static const nByte typeName = TypeCode::BYTE;
};
template <>
struct ConfirmAllowedKey<short>
{
	typedef short type;
	static const nByte typeName = TypeCode::SHORT;
};
template <>
struct ConfirmAllowedKey<int>
{
	typedef int type;
	static const nByte typeName = TypeCode::INTEGER;
};
template <>
struct ConfirmAllowedKey<int64>
{
	typedef int64 type;
	static const nByte typeName = TypeCode::LONG;
};
template <>
struct ConfirmAllowedKey<float>
{
	typedef float type;
	static const nByte typeName = TypeCode::EG_FLOAT;
};
template <>
struct ConfirmAllowedKey<double>
{
	typedef double type;
	static const nByte typeName = TypeCode::DOUBLE;
};
template <>
struct ConfirmAllowedKey<JString>
{
	typedef JString type;
	static const nByte typeName = TypeCode::STRING;
};
template <>
struct ConfirmAllowedKey<char *>
{
	typedef JString type;
	static const nByte typeName = TypeCode::STRING;
};
template <>
struct ConfirmAllowedKey<const char *>
{
	typedef JString type;
	static const nByte typeName = TypeCode::STRING;
};
template <unsigned int N>
struct ConfirmAllowedKey<char[N]>
{
	typedef JString type;
	static const nByte typeName = TypeCode::STRING;
};
template <unsigned int N>
struct ConfirmAllowedKey<const char[N]>
{
	typedef JString type;
	static const nByte typeName = TypeCode::STRING;
};
template <>
struct ConfirmAllowedKey<wchar_t *>
{
	typedef JString type;
	static const nByte typeName = TypeCode::STRING;
};
template <>
struct ConfirmAllowedKey<const wchar_t *>
{
	typedef JString type;
	static const nByte typeName = TypeCode::STRING;
};
template <unsigned int N>
struct ConfirmAllowedKey<wchar_t[N]>
{
	typedef JString type;
	static const nByte typeName = TypeCode::STRING;
};
template <unsigned int N>
struct ConfirmAllowedKey<const wchar_t[N]>
{
	typedef JString type;
	static const nByte typeName = TypeCode::STRING;
};
template <>
struct ConfirmAllowedKey<Object>
{
	typedef Object type;
